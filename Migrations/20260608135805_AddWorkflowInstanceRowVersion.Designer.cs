...
namespace dwa_ver_val.Migrations
{
    ...
    [Migration("20260608135805_AddWorkflowInstanceRowVersion")]
    partial class AddWorkflowInstanceRowVersion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CropWaterRate", b =>
                {
                    b.Property<Guid>("CropWaterRateId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("RatePerHaPerAnnum")
                        .HasColumnType("decimal(18, 2)");

                    b.Property<string>("Source")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("CropWaterRateId");

                    b.HasIndex("IrrigationSystemId");

                    b.HasIndex("CropId", "IrrigationSystemId")
                        .IsUnique()
                        .HasFilter("[IrrigationSystemId] IS NOT NULL");

                    b.ToTable("CropWaterRates");
                });
            ...
            modelBuilder.Entity("DamCalculation", b =>
                {
                    ...
                    b.Property<decimal?>("ContourDifference")
                        .HasColumnType("decimal(18, 2)");

                    b.Property<decimal?>("DamArea")
                        .HasColumnType("decimal(18, 2)");
                    ...
                    b.Property<decimal?>("DamDepth")
                        .HasColumnType("decimal(18, 2)");

                    b.Property<string>("DamNumber")
                        .HasColumnType("nvarchar(max)");

                    b.Property<decimal?>("Fetch")
                        .HasColumnType("decimal(18, 2)");
                    ...
                    b.Property<decimal?>("RiverDistance")
                        .HasColumnType("decimal(18, 2)");
                    ...
                    b.Property<decimal?>("ShapeFactor")
                        .HasColumnType("decimal(18, 2)");

                    b.Property<decimal?>("WallLength")
                        .HasColumnType("decimal(18, 2)");
            ...
            modelBuilder.Entity("FileMaster", b =>
                {
                    ...
                    b.Property<DateTime?>("PrePublicReviewApprovedAt")
                        .HasColumnType("datetime2");

                    b.Property<Guid?>("PrePublicReviewApprovedById")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("S33_2_IrrigationBoardId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<bool>("S33_2_RatesPaidConfirmed")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<string>("S33_2_ScheduledAreaName")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.Property<int?>("StakeholderWorkshopAttendance")
                        .HasColumnType("int");

                    b.Property<DateTime?>("StakeholderWorkshopDate")
                        .HasColumnType("datetime2");

                    b.Property<string>("StakeholderWorkshopVenue")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("PrePublicReviewApprovedById");

                    b.HasIndex("PropertyId");

                    b.HasIndex("S33_2_IrrigationBoardId");

                    b.HasIndex("ValidationStatusName")
            ...
            modelBuilder.Entity("LawfulnessAssessmentResult", b =>
                {
                    b.Property<Guid>("LawfulnessAssessmentResultId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("GwcaId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("IrrigationLimitApplied")
                        .HasColumnType("nvarchar(max)");

                    b.Property<decimal>("LawfulIrrigationM3")
                        .HasColumnType("decimal(18, 2)");

                    b.Property<decimal>("LawfulStorageM3")
                        .HasColumnType("decimal(18, 2)");
                    ...
                    b.Property<decimal>("TotalDamCapacityM3")
                        .HasColumnType("decimal(18, 2)");

                    b.Property<decimal>("TotalIrrigatedAreaHa")
                        .HasColumnType("decimal(18, 2)");

                    b.Property<decimal>("TotalIrrigationDemandM3")
                        .HasColumnType("decimal(18, 2)");

                    b.Property<decimal>("UnlawfulIrrigationM3")
                        .HasColumnType("decimal(18, 2)");

                    b.Property<decimal>("UnlawfulStorageM3")
                        .HasColumnType("decimal(18, 2)");

                    b.HasKey("LawfulnessAssessmentResultId");
                    ...
                    b.ToTable("LawfulnessAssessmentResults");
                });
            ...
            modelBuilder.Entity("LetterIssuance", b =>
                {
                    ...
                    b.Property<DateOnly?>("ServiceConfirmedDate")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("Objection", b =>
                {
                    ...
                    b.HasIndex("FileMasterId", "PublicUserId")
                        .IsUnique()
            ...
            modelBuilder.Entity("PAJAChecklist", b =>
                {
                    b.Property<Guid>("PAJAChecklistId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("FinalReasoning")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("LegalBasis")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("UserInputConsideration")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("PAJAChecklistId");
            ...
            modelBuilder.Entity("Property", b =>
                {
                    ...
                    b.Property<decimal?>("IrrigableAreaHa")
                        .HasColumnType("decimal(18, 2)");
            ...
            modelBuilder.Entity("SfraSpeciesRate", b =>
                {
                    b.Property<Guid>("SfraSpeciesRateId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("RateM3PerHaPerAnnum")
                        .HasColumnType("decimal(18, 2)");
                    ...
                    b.HasKey("SfraSpeciesRateId");

                    b.HasIndex("SpeciesName")
                        .IsUnique();

                    b.ToTable("SfraSpeciesRates");
                });
            ...
            modelBuilder.Entity("SmsOtp", b =>
                {
                    b.Property<Guid>("SmsOtpId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PublicUserId", "Used", "ExpiresAt")
            ...
            modelBuilder.Entity("TrustedDevice", b =>
                {
                    ...
                    b.HasIndex("PublicUserId", "ExpiresAt")
            ...
            modelBuilder.Entity("FileMaster", b =>
                {
                    ...
                    b.HasOne("ApplicationUser", "PrePublicReviewApprovedBy")
                        .WithMany()
                        .HasForeignKey("PrePublicReviewApprovedById")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("IrrigationBoard", "S33_2_IrrigationBoard")
                        .WithMany()
                        .HasForeignKey("S33_2_IrrigationBoardId")
                    ...
                    b.Navigation("PrePublicReviewApprovedBy");

                    b.Navigation("Property");

                    b.Navigation("S33_2_IrrigationBoard");
            ...
            modelBuilder.Entity("LawfulnessAssessmentResult", b =>
                {
                    b.HasOne("FileMaster", "FileMaster")
                        .WithOne()
                        .HasForeignKey("LawfulnessAssessmentResult", "FileMasterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PAJAChecklist", b =>
                {
                    ...
                    b.HasOne("FileMaster", "FileMaster")
                        .WithOne()
                        .HasForeignKey("PAJAChecklist", "FileMasterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Property", b =>
                {
                    ...
                    b.Navigation("GovernmentWaterControlArea");
