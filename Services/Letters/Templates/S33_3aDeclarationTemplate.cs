...
/// <summary>S33(3)(a) — Declaration of ELU on individual application, category A.</summary>
public class S33_3aDeclarationTemplate : ILetterTemplate
{
    public string LetterCode => "S33_3a_Decl";
    public string Title => "Declaration of existing lawful water use — individual application (Category A)";
    public string NWAReference => "Section 33(3)(a) of the National Water Act (Act 38 of 1998)";
    ...
    public void Compose(IContainer container, LetterContext ctx)
    {
        container.Column(col =>
        {
            ...
            col.Item().PaddingTop(10).Text(
                ...
                "Section 33(3)(a) of the Act (Category A)."
            );
